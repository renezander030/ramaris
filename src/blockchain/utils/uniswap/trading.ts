...
export async function executeTrade(
  trade: TokenTrade,
 provider: any,
wallet:any): Promise<TransactionState> {
  ...
  const tokenApproval = await getTokenTransferApproval(CurrentConfig.tokens.in, provider, wallet)
...
export async function getOutputQuote(route: Route<Currency, Currency>, provider: any) {
...
export async function getTokenTransferApproval(
  token: Token, provider: any, wallet: any
